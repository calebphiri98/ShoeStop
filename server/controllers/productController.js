...
// // 2. Create a new product entry (Fixed for Schema constraints)
// exports.createProduct = async (req, res) => {
...
//     // Map single image URL into a Native Text Array literal ([]) matching standard TEXT[] schema column definitions
//     const imageAssetArray = [image_url || 'https://via.placeholder.com/150'];
...
// // // Append this to your existing product controller file:
...
// //       VALUES ($1, $2, $3, $4) 
// //       RETURNING *`;
// //     const values = [name, Number(price), image_url || 'https://via.placeholder.com/150', category || 'sneakers'];
...
// // // Update an existing product's pricing model
// // exports.updateProductPrice = async (req, res) => {
// //   const { id } = req.params;
// //   const { price } = req.body;
