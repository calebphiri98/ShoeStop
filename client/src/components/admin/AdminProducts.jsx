...
const AdminProducts = ({ token }) => {
  ...
  const uploadImageFile = async () => {
    ...
    // ⚡ CORRECTED ENDPOINT: Points precisely to the nested route configuration mapped on your backend router
  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      ...
      // 🛠️ Match database schema expectation: wrap url target in a string array structure
      const res = await fetch(`${API_URL}/api/products`, {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...
          images: [finalImageUrl], // Converted to array mapping directly to images TEXT[]
...
//               className="w-full border border-gray-200 p-2 text-primary font-bold focus:outline-none focus:border-primary bg-white rounded"
//             >
//               {/* Updated to cleanly track your structural navigation targets */}
//               <option value="Men">Men</option>
//               <option value="Women">Women</option>
//               <option value="Unisex">Unisex</option>
//             </select>
