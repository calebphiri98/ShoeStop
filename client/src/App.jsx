...
// Layout shell that hides the public Navbar + bottom nav on admin/dashboard routes
const AppShell = () => {
  const location = useLocation();
  const isBackoffice = location.pathname.startsWith('/admin') || location.pathname.startsWith('/dashboard');
