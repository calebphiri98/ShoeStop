...
//       {/* CORE WORKSPACE ENTRY CONTAINER */}
//       {/* 🛠️ CORRECTED MOBILE SPACING: Reduced padding from p-4 to px-3 py-4, and tightened layout margins */}
//       <main className="flex-1 px-3 py-4 sm:p-6 md:p-10 overflow-x-hidden">
//         <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 pb-3 border-b border-gray-200">
//           <h2 className="text-lg sm:text-2xl md:text-3xl font-bold uppercase tracking-wide text-primary">
//             {activeTab === 'overview' && 'Dashboard Overview'}
...
// // import AdminOverview from '../components/admin/AdminOverview';
// // import AdminOrders from '../components/admin/AdminOrders';
// // import AdminProducts from '../components/admin/AdminProducts'; // NEW ENTRY IMPORT
// // import Signup from './Signup'; 
...
// //       {/* CORE WORKSPACE ENTRY CONTAINER */}
// //       <main className="flex-1 p-3 sm:p-6 md:p-10 overflow-x-hidden">
// //         <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 sm:mb-8 pb-3 sm:pb-4 border-b border-gray-200">
...
// //             {activeTab === 'customers' && 'Account Provisioning & Users'}
// //           </h2>
// //           <button onClick={logout} className="w-full sm:w-auto bg-primary text-secondary px-4 py-1.5 sm:px-5 sm:py-2 font-bold uppercase text-xs tracking-wider border border-transparent hover:bg-transparent hover:text-primary hover:border-primary transition-all duration-200 text-center">
// //             Secure Logout
// //           </button>
// //         </header>
